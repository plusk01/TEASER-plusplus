...
[s, R, t, time_taken,...
inlier_graph, maxclique, rin, tin] = teaser_solve_mex(src, dst, cbar2, ...
...
[s, R, t, time_taken] = teaser_solve(src, dst, 'Cbar2', cbar2,...
                             'NoiseBound', noise_bound, ...
                             'EstimateScaling', estimate_scaling,...
